...
+ *Text Editor* - Zed, [[https://emacs.rkar.org][Emacs]]
+ *Terminal Emulator* - Ghostty + [[https:herdr.dev][Herdr]] +iTerm2+ +WezTerm+ +Tmux+
+ *Web Browser* - Safari, Brave
+ *Misc* - Nix-darwin, Zsh, Obsidian
...
+ *Work Computer* - 14" M5 Pro MacBook Pro (2026)
+ *Personal Computer* - Custom build (Ryzen 5600x/Nvidia 3070 FE)
+ *Handheld Computer* - Steam Deck OLED (2023)
+ *Keyboards* - A bunch of [[https://mrprofessor.dev][boards]]
+ *Headphones* - SteelSeries Arctis 7 (Xbox Edition)
